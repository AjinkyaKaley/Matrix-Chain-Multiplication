 ...
 * @author Ajinkya Kale
 * 
 * This program is an application of matrix multiplication
 *  
 */
public class MatrixChainParenthesize {
	 ...
	 */
	public MatrixChainParenthesize(int i, String [] index) {
		S = new int[i+1][i+1];
		M = new int[i+1][i+1];
		p = new int[i+1];
		A = new String[i+1];
	...
	public static void main(String[] args) {
		...
		MatrixChainParenthesize q = new MatrixChainParenthesize(n,index);
